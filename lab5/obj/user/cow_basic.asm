  ...
  80052c:	43050513          	addi	a0,a0,1072 # 800958 <error_string+0xd8>
{
  ...
  80055a:	b85ff0ef          	jal	ra,8000de <fork>
    if (pid < 0)
  80055e:	0a054063          	bltz	a0,8005fe <main+0xd8>
    {
        fail("fork failed");
    }
    else if (pid == 0)
  800562:	e91d                	bnez	a0,800598 <main+0x72>
    {
        // Child: verify inherited data, then modify to trigger COW.
        if (buf[0] != 'P' || buf[PGSIZE] != 'Q')
  800564:	00001717          	auipc	a4,0x1
  800568:	a9c70713          	addi	a4,a4,-1380 # 801000 <buf>
  80056c:	00074683          	lbu	a3,0(a4)
  800570:	05000793          	li	a5,80
  800574:	00f69c63          	bne	a3,a5,80058c <main+0x66>
  800578:	00002797          	auipc	a5,0x2
  80057c:	a8878793          	addi	a5,a5,-1400 # 802000 <buf+0x1000>
  800580:	0007c603          	lbu	a2,0(a5)
  800584:	05100693          	li	a3,81
  800588:	04d60a63          	beq	a2,a3,8005dc <main+0xb6>
        {
            fail("child observed wrong initial data");
  80058c:	00000517          	auipc	a0,0x0
  800590:	3fc50513          	addi	a0,a0,1020 # 800988 <error_string+0x108>
  800594:	f7bff0ef          	jal	ra,80050e <fail>
    ...
    wait();
  800598:	b49ff0ef          	jal	ra,8000e0 <wait>
    if (buf[0] != 'P' || buf[PGSIZE] != 'Q')
  80059c:	00001717          	auipc	a4,0x1
  8005a0:	a6474703          	lbu	a4,-1436(a4) # 801000 <buf>
  8005a4:	05000793          	li	a5,80
  8005a8:	06f71163          	bne	a4,a5,80060a <main+0xe4>
  8005ac:	00002717          	auipc	a4,0x2
  8005b0:	a5474703          	lbu	a4,-1452(a4) # 802000 <buf+0x1000>
  8005b4:	05100793          	li	a5,81
  8005b8:	04f71963          	bne	a4,a5,80060a <main+0xe4>
    {
  ...
  8005c0:	44c50513          	addi	a0,a0,1100 # 800a08 <error_string+0x188>
  8005c4:	a7dff0ef          	jal	ra,800040 <cprintf>
    cprintf("=== cow_basic: done ===\n");
  8005c8:	00000517          	auipc	a0,0x0
  8005cc:	46850513          	addi	a0,a0,1128 # 800a30 <error_string+0x1b0>
  8005d0:	a71ff0ef          	jal	ra,800040 <cprintf>
    return 0;
}
  8005d4:	60a2                	ld	ra,8(sp)
  8005d6:	4501                	li	a0,0
  8005d8:	0141                	addi	sp,sp,16
  8005da:	8082                	ret
        buf[0] = 'C';
  8005dc:	04300693          	li	a3,67
  8005e0:	00d70023          	sb	a3,0(a4)
        buf[PGSIZE] = 'D';
  8005e4:	04400713          	li	a4,68
        cprintf("child wrote C/D, exiting\n");
  8005e8:	00000517          	auipc	a0,0x0
  8005ec:	3c850513          	addi	a0,a0,968 # 8009b0 <error_string+0x130>
        buf[PGSIZE] = 'D';
  8005f0:	00e78023          	sb	a4,0(a5)
        cprintf("child wrote C/D, exiting\n");
  8005f4:	a4dff0ef          	jal	ra,800040 <cprintf>
        exit(0);
  8005f8:	4501                	li	a0,0
  8005fa:	acfff0ef          	jal	ra,8000c8 <exit>
        fail("fork failed");
  8005fe:	00000517          	auipc	a0,0x0
  800602:	37a50513          	addi	a0,a0,890 # 800978 <error_string+0xf8>
  800606:	f09ff0ef          	jal	ra,80050e <fail>
        fail("parent data changed after child write (COW broken)");
  80060a:	00000517          	auipc	a0,0x0
  80060e:	3c650513          	addi	a0,a0,966 # 8009d0 <error_string+0x150>
  800612:	efdff0ef          	jal	ra,80050e <fail>
