...
exit(int error_code) {
  ...
  8000d4:	49850513          	addi	a0,a0,1176 # 800568 <main+0x6c>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800130:	45478793          	addi	a5,a5,1108 # 800580 <main+0x84>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  80018c:	42ca8a93          	addi	s5,s5,1068 # 8005b4 <main+0xb8>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
  ...
  800194:	640b8b93          	addi	s7,s7,1600 # 8007d0 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  8003ea:	1ca60613          	addi	a2,a2,458 # 8005b0 <main+0xb4>
  ...
  8003fc:	1a860613          	addi	a2,a2,424 # 8005a0 <main+0xa4>
  ...
  80040e:	18e40413          	addi	s0,s0,398 # 800598 <main+0x9c>
  ...
  800498:	10440413          	addi	s0,s0,260 # 800598 <main+0x9c>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
  ...
  8004ae:	0efa0a13          	addi	s4,s4,239 # 800599 <main+0x9d>
...
int main(void) {
  ...
  800502:	39a50513          	addi	a0,a0,922 # 800898 <error_string+0xc8>
int main(void) {
  800506:	e406                	sd	ra,8(sp)
    cprintf("=== cow_ro: start ===\n");
  800508:	b39ff0ef          	jal	ra,800040 <cprintf>
    ...
    int pid = fork();
  80050c:	bd3ff0ef          	jal	ra,8000de <fork>
    if (pid < 0) {
  800510:	02054563          	bltz	a0,80053a <main+0x3e>
        fail("fork failed");
    }

    if (pid == 0) {
  800514:	c121                	beqz	a0,800554 <main+0x58>
    ...
    wait();
  800516:	bcbff0ef          	jal	ra,8000e0 <wait>
    cprintf("PASS: read-only segments shared without COW faults\n");
  80051a:	00000517          	auipc	a0,0x0
  80051e:	3ce50513          	addi	a0,a0,974 # 8008e8 <error_string+0x118>
  800522:	b1fff0ef          	jal	ra,800040 <cprintf>
    cprintf("=== cow_ro: done ===\n");
  800526:	00000517          	auipc	a0,0x0
  80052a:	3fa50513          	addi	a0,a0,1018 # 800920 <error_string+0x150>
  80052e:	b13ff0ef          	jal	ra,800040 <cprintf>
    return 0;
}
  800532:	60a2                	ld	ra,8(sp)
  800534:	4501                	li	a0,0
  800536:	0141                	addi	sp,sp,16
  800538:	8082                	ret
    cprintf("FAIL: %s\n", m);
  80053a:	00000597          	auipc	a1,0x0
  80053e:	37658593          	addi	a1,a1,886 # 8008b0 <error_string+0xe0>
  800542:	00000517          	auipc	a0,0x0
  800546:	37e50513          	addi	a0,a0,894 # 8008c0 <error_string+0xf0>
  80054a:	af7ff0ef          	jal	ra,800040 <cprintf>
    exit(-1);
  80054e:	557d                	li	a0,-1
  800550:	b79ff0ef          	jal	ra,8000c8 <exit>
        cprintf("child ro/read ok\n");
  800554:	00000517          	auipc	a0,0x0
  800558:	37c50513          	addi	a0,a0,892 # 8008d0 <error_string+0x100>
  80055c:	ae5ff0ef          	jal	ra,800040 <cprintf>
        exit(0);
  800560:	4501                	li	a0,0
  800562:	b67ff0ef          	jal	ra,8000c8 <exit>
