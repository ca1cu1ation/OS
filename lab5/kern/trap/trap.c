...
void interrupt_handler(struct trapframe *tf)
{
    ...
    case IRQ_S_TIMER:
        ...
        /* LAB3 EXERCISE1   YOUR CODE :2312773  */
    ...
    case CAUSE_STORE_PAGE_FAULT:
        {
            ...
            // Construct error_code for do_pgfault in x86-style format:
            // bit 0: P (present) - 0 = not present, 1 = present
            // bit 1: W/R (write/read) - 0 = read, 1 = write
            // Since RISC-V page fault means page not in TLB/not accessible,
            // but the page might exist in page table with wrong permissions (COW case),
